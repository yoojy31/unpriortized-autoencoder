...
#---------------------------------------------------------------------------------------------------------------
# LOAD_SNAPSHOT_DIR='result/training/cifar10/32x32/100/ae/20181109-052102-ae00(mse1.0)-(mwup0)/snapshot/epoch-80'
# RESULT_DIR=./result/plot/cifar10/32x32/100/`(date "+%Y%m%d-%H%M%S")`-'ae00(mse1.0)-(mwup0)'

# LOAD_SNAPSHOT_DIR='result/training/cifar10/32x32/100/ae/20181109-052150-ae00(mse1.0)-(mwup50)/snapshot/epoch-80'
# RESULT_DIR=./result/plot/cifar10/32x32/100/`(date "+%Y%m%d-%H%M%S")`-'ae00(mse1.0)-(mwup50)'

# LOAD_SNAPSHOT_DIR='result/training/cifar10/32x32/100/ae/20181109-055246-ae00(mse1.0-perc0.1)-(mwup0)/snapshot/epoch-80'
# RESULT_DIR=./result/plot/cifar10/32x32/100/`(date "+%Y%m%d-%H%M%S")`-'ae00(mse1.0-perc0.1)-(mwup0)'

LOAD_SNAPSHOT_DIR='result/training/cifar10/32x32/100/ae/20181109-055234-ae00(mse1.0-perc0.1)-(mwup50)/snapshot/epoch-80'
RESULT_DIR=./result/plot/cifar10/32x32/100/`(date "+%Y%m%d-%H%M%S")`-'ae00(mse1.0-perc0.1)-(mwup50)'
...
\
--dataset=cifar \
--dataset_path=./data/cifar10/test \
--batch_size=64 \
--max_iters=20 \
\
--img_size=32 \
